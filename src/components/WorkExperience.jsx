				...
				<div className="mt-5">
					...
					>
						<div className="flex gap-4 items-center">
							<h2 className="mt-0.5">Live Demo</h2>
	...
	return (
		<>
			...
			<div className="w-full flex">
				...
				>
					Following Work Experience showcases my skills and experience
					through real-world examples of my work. Each project is
					briefly described with links to code repositories and my
					contributions in it. It reflects my ability to solve complex
